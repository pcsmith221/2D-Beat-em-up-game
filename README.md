...
This repository is used to backup and share all the scripts created during the development of _The Winds of Boriken_, a 2D beat-em-up game inspired by the mythology of the indigenous people of Puerto Rico, the Taino. The project was developed with the Unity game engine in C#. The game was made in partnership with David Monsegur, an art student at UTSA who drew the majority of the visual assets used in the game by hand. The game is not yet publicly available for play, but the core gameplay features are complete, including player movement, combat, local split keyboard multiplayer, enemy AI random state machines, enemy spawners and wave events, in game cinematics and boss fights, start and game over menus, player UI, various gameplay managers, and more. 
